...
import apic_em_apis
import utils
from modules_init import EM_USER, EM_PASSW
...
def main():
    """
    The script will initiate an APIC-EM path trace using the Cisco DevNet Sandbox: https://sandboxapicem.cisco.com/
    APIC-EM url, username and password are configured in the modules_init module. Change these variables if needed to
